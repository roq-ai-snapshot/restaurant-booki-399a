  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine: Streamlining Table Reservations and Menu Management for Restaurants, Making Dining Experiences More Seamless for Customers"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine: Streamlining Table Reservations and Menu Management for Restaurants, Making Dining Experiences More Seamless for Customers`}
            </Text>
            <Box
